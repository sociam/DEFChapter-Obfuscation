...
Meanwhile, the rise of tracking has not been met with a corresponding increase in either public awareness of it, nor many practical ways with which citizens can protect themselves from unwanted profiling and surveillance.  As a result, a great asymmetry has arisen between those that track, comprising information brokers with vast resources, and those end-user citizens that are tracked with little choice.  As if this asymmetry was not problematic enough, the few privacy enhancing tools that have proven effective against surveillance are often smeared by news and media networks as ``tools for terrorst and paedophiles'' to discourage their adoption from mainstream user base (e.g. \cite{bbctor,fbicommunities}).
% 
