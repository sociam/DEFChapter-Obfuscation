...
% Bruce Schneider: ``privacy is not about something to hide its about autonomy and control; when you are observed you cannot be in control''
...
\emph{inconvertible}, and \emph{intrinsically useless}, and hence must derive
...
The analogous approach to personal data would be a personal data economy in
which participants decided what and how they wanted to share, where sharing was
based on personal utility rather than centralised dictate.
...
four data points being enough for re-identification in many cases~\cite{montjoye2013Unique}.
