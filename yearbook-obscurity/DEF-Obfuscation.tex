...
deception, and \emph{anti-social} forms of deception
\cite{iniguez2014Deception}.  A wide range of pro-social kinds of deception have
...
facilitate the use of pro-social deception for thep purpose of efficient
...
avoid talking to someone for another reason.  In work by Aoki and Woodruff
\cite{Aoki:2005:MSS:1054972.1054998}, it is argued that such uses of ambiguity
...
or damaging situations, while simultaneously incurring low social risk in the
process.  They also point out that, as digital systems become increasingly
sensor enabled and aware of people's activities in order to provide enable more
...
designers to thus design into them the ability for people to give themselves the
...
2011\footnote{\url{http://radar.oreilly.com/2011/04/apple-location-tracking.html}
% \\ArsTechnica: \url{ 
