...
information in the browser, throught the Chrome Developer Tools emulator.
...
maiden's name, username and password, employment information, weight and 
height and blood type, and even a favourite colour. Using the persona 
consistently online enables a complete separation between the real person and 
their presence online. It is difficult, of not impossible to use these personas 
when dealing with official (regulated) services as mentioned above.
